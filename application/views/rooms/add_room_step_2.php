        ...
        <div class="content-wrapper">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    ...
                    ?>
                    <h5 class="panel-title">STEP 2 : Adding Photos for Room: <strong><?= strtoupper($room->roomnumber)?></strong> in <strong><?= ucwords($getestate)?></strong></h5>
                ...
                success: function (results) {
                    ...
                    if (data === 'images_ready') {
                        Swal.fire({
                            ...
                            location.href = "<?= site_url('welcome/rooms/steps_complete/'.$id)?>";
                        })
                        ...
                        Swal.fire({
                            title: 'Failed',
                            type: 'info',
                            text: 'Please add more than 2 Images for this Hotel listing',
                            confirmButtonText:
                                'OK',
                        ...
                        Swal.fire({
                            title: 'Add Images',
                            type: 'info',
                            text: 'Minimum of 3 Images for this Listing is required',
                            confirmButtonText:
                                'OK',
