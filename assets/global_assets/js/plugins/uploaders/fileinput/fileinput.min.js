...
!function (e) {
    ...
    i = {
        ...
        dataURI2Blob: function (e) {
            ...
            if (!c) return null;
            for (t = e.split(",")[0].indexOf("base64") >= 0 ? atob(e.split(",")[1]) : decodeURIComponent(e.split(",")[1]), a = new ArrayBuffer(t.length), r = new Uint8Array(a), n = 0; n < t.length; n += 1) r[n] = t.charCodeAt(n);
        ...
        setOrientation: function (e, i) {
            var t, a, r, n = new DataView(e), o = 0, l = 1;
            if (65496 !== n.getUint16(o) || e.length < 2) return void (i && i());
            for (o += 2, t = n.byteLength; t - 2 > o;) switch (a = n.getUint16(o), o += 2, a) {
                case 65505:
                    r = n.getUint16(o), t = r - o, o += 2;
                    break;
                case 274:
        ...
        adjustOrientedImage: function (e, i) {
            ...
            if (e.hasClass("is-portrait-gt4")) {
                ...
                e.css({
                    height: "auto",
                    width: e.height()
                }), t = e.parent().offset().top, a = e.offset().top, r = t - a, e.css("margin-top", r)
            }
        }
    }, t = function (t, a) {
        var r = this;
        ...
        constructor: t, _cleanup: function () {
            ...
            var t, a, r, n, o, l, s, d, c, u, p, f, m, h, v, g, w, _, b, C, y, T, E, x, S, F, I, k, P, z, A, $, D, U, B,
                j, R = this;
            ...
            t.previewCache = {
                data: {}, init: function () {
                    ...
                    var n, o, l, s, d, c, u, p = "init_" + a, f = t.previewCache.data, m = f.config[a],
                        h = f.content[a], v = t.previewInitId + "-" + p,
                    ...
                    a = void 0 === a ? !0 : a;
                    var o, l = n.config[e], s = i.ifSet("caption", l), d = i.ifSet("width", l, "auto"),
                        ...
                        v = i.ifSet("showDrag", l, i.ifSet("showDrag", p, !0)), g = c === !1 && a;
                    return o = t._renderFileActions(!1, m, h, v, g, c, u, !0), t._getLayoutTemplate("footer").setTokens({
            ...
            var t = this, a = e.target.error, r = function (e) {
            ...
            e && (t = a.msgFoldersNotAllowed.replace("{n}", e), a._addError(t), i.addCss(a.$container, "has-error"), r.fadeIn(800), a._raise("filefoldererror", [e, t]))
            ...
            var t, a = this, r = null;
            return i && i.indexOf(".") > -1 && (t = i.split(".").pop(), a.previewFileIconSettings && (r = a.previewFileIconSettings[t] || a.previewFileIconSettings[t.toLowerCase()] || null), a.previewFileExtSettings && e.each(a.previewFileExtSettings, function (e, i) {
                return a.previewFileIconSettings[e] && i(t) ? void (r = a.previewFileIconSettings[e]) : void 0
            })), r
        }, _parseFilePreviewIcon: function (e, i) {
            var t = this, a = t._getPreviewIcon(i) || t.previewFileIcon, r = e;
            ...
            var t = this, a = t.$preview,
                r = t.showUploadedThumbs ? t.getFrames(":not(.file-preview-success)") : t.getFrames();
            r.each(function () {
                var t = e(this);
            ...
            window.KvSortable && 0 !== r.find(n).length && (t = {
                ...
                onSort: function (t) {
                    ...
                    for (var s = 0; s < a.initialPreviewConfig.length; s++) null !== a.initialPreviewConfig[s] && (r = a.initialPreviewConfig[s].key, n = e(".kv-file-remove[data-key='" + r + "']").closest(i.FRAMES), n.attr("data-fileindex", "init_" + s).attr("data-fileindex", "init_" + s));
                    a._raise("filesorted", {
            ...
            var i, t, a = this, r = a.$modal.data("previewId") || "", n = a.getFrames().toArray(), o = n.length,
                l = a.$modal.find(".btn-prev"), s = a.$modal.find(".btn-next");
            return n.length < 2 ? (l.hide(), void s.hide()) : (l.show(), s.show(), void (o && (i = e(n[0]), t = e(n[o - 1]), l.removeAttr("disabled"), s.removeAttr("disabled"), i.length && i.attr("id") === r && l.attr("disabled", !0), t.length && t.attr("id") === r && s.attr("disabled", !0))))
            ...
            var r, n, o, l, s, d, c, u, p, f, m = this, h = t.attr("id"), v = m.$modal, g = v.find(".btn-prev"),
                w = v.find(".btn-next"), _ = v.find(".btn-fullscreen"), b = v.find(".btn-borderless"),
                C = v.find(".btn-toggleheader"), y = m.$preview.find("#zoom-" + h);
            n = y.attr("data-template") || "generic", r = y.find(".kv-file-content"), o = r.length ? r.html() : "", p = t.data("caption") || "", f = t.data("size") || "", l = p + " " + f, v.find(".kv-zoom-title").html(l), s = v.find(".kv-zoom-body"), v.removeClass("kv-single-content"), a ? (u = s.addClass("file-thumb-loading").clone().insertAfter(s), s.html(o).hide(), u.fadeOut("fast", function () {
            ...
            T.length && i.adjustOrientedImage(T, !0), m._handler(g, "click", function () {
                ...
                37 !== i || g.attr("disabled") || m._zoomSlideShow("prev", h), 39 !== i || w.attr("disabled") || m._zoomSlideShow("next", h)
            })
            ...
            var a, r, n, o = this, l = o.$modal.find(".kv-zoom-actions .btn-" + i), s = o.getFrames().toArray(),
                d = s.length;
            if (!l.attr("disabled")) {
                for (r = 0; d > r; r++) if (e(s[r]).attr("id") === t) {
                    n = "prev" === i ? r - 1 : r + 1;
                    break
                }
                0 > n || n >= d || !s[n] || (a = e(s[n]), a.length && o._setZoomContent(a, !0), o._initZoomButtons(), o._raise("filezoom" + i, {
                    previewId: t,
                    modal: o.$modal
                }))
            }
            ...
            t.showPreview && t._getThumbs(i.FRAMES + ".file-preview-success").each(function () {
                ...
                n.removeAttr("disabled"), t._handler(n, "click", function () {
                    var e = a.attr("id"), n = t._raise("filesuccessremove", [e, a.attr("data-fileindex")]);
            ...
            var r, n, o, l, s, d, c, u, p, f, m, h = this, v = h.getFileStack().length, g = new FormData,
                w = h.previewInitId + "-" + t, _ = h.filestack.length > 0 || !e.isEmptyObject(h.uploadExtraData),
                b = e("#" + w).find(".file-thumb-progress"), C = {id: w, index: t};
            h.formdata = g, h.showPreview && (n = e("#" + w + ":not(.file-preview-initial)"), l = n.find(".kv-file-upload"), s = n.find(".kv-file-remove"), b.removeClass("hide")), 0 === v || !_ || l && l.hasClass("disabled") || h._abort(C) || (m = function (e, i) {
                d || h.updateStack(e, void 0), h.uploadLog.push(i), h._checkAsyncComplete() && (h.fileBatchCompleted = !0)
            }, o = function () {
                var e, t, a, r = h.uploadCache, n = 0, o = h.cacheInitialPreview;
                h.fileBatchCompleted && (o && o.content && (n = o.content.length), setTimeout(function () {
                    var l = 0 === h.getFileStack(!0).length;
                    if (h.showPreview) {
                        ...
                        } else h.initialPreview = r.content, h.initialPreviewConfig = r.config, h.initialPreviewThumbTags = r.tags;
                ...
                var u = h.showPreview && n.attr("id") ? n.attr("id") : w;
                r = h._getOutData(c, o), e.extend(!0, C, r), setTimeout(function () {
                ...
                var s = h.ajaxOperations.uploadThumb,
                    c = h._parseError(s, i, o, a && h.filestack[t].name ? h.filestack[t].name : null);
            ...
            "init_" === r.substring(0, 5) && (r = parseInt(r.replace("init_", "")), a.initialPreview = i.spliceArray(a.initialPreview, r), a.initialPreviewConfig = i.spliceArray(a.initialPreviewConfig, r), a.initialPreviewThumbTags = i.spliceArray(a.initialPreviewThumbTags, r), a.getFrames().each(function () {
                var i = e(this), t = i.attr("data-fileindex");
            ...
            t.showPreview && (t._initZoomButton(), t.getFrames(" .kv-file-remove").each(function () {
                var r, n, o, l, s = e(this), d = s.closest(i.FRAMES), c = d.attr("id"), u = d.attr("data-fileindex");
                t._handler(s, "click", function () {
                    return l = t._raise("filepreremove", [c, u]), l !== !1 && t._validateMinCount() ? (r = d.hasClass("file-preview-error"), i.cleanMemory(d), void d.fadeOut("slow", function () {
                        ...
                        0 !== p || 0 !== s || f ? (n = s + p, o = n > 1 ? t._getMsgSelected(n) : l[0] ? t._getFileNames()[0] : "", t._setCaption(o)) : t.reset(), t._raise("fileremoved", [c, u])
                    })) : !1
                })
                ...
                t._handler(a, "click", function () {
                    ...
                    t.$progress.addClass("hide"), e.hasClass("file-preview-error") && !t.retryErrorUploads || t._uploadSingle(r, !1)
                })
            }))
            ...
            t._initZoomButton(), a.find(n).each(function () {
                ...
                if (!i.isEmpty(l) && void 0 !== s) {
                    var d, c, u, p, f = n.closest(i.FRAMES), m = t.previewCache.data, h = f.attr("data-fileindex");
                    h = parseInt(h.replace("init_", "")), u = i.isEmpty(m.config) && i.isEmpty(m.config[h]) ? null : m.config[h], p = i.isEmpty(u) || i.isEmpty(u.extra) ? r : u.extra, "function" == typeof p && (p = p()), c = {
                        id: n.attr("id"),
                        key: s,
                        extra: p
                    }, d = e.extend(!0, {}, {
                        ...
                        success: function (e, r, l) {
                            var d, u;
                            return i.isEmpty(e) || i.isEmpty(e.error) ? (h = parseInt(f.attr("data-fileindex").replace("init_", "")), t.previewCache.unset(h), d = t.previewCache.count(), u = d > 0 ? t._getMsgSelected(d) : "", t._deleteFileIndex(f), t._setCaption(u), t._raise("filedeleted", [s, l, p]), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow", function () {
        ...
        }, _generatePreviewTemplate: function (t, a, r, n, o, l, s, d, c, u, p) {
            var f, m = this, h = m.slug(r), v = "", g = m.previewSettings[t] || m.defaults.previewSettings[t],
                w = g && g.width ? g.width : "", _ = g && g.height ? g.height : "",
                b = c || m._renderFileFooter(h, s, i.isEmpty(w) ? "auto" : w, l), C = m._getPreviewIcon(r),
                y = "type-default", T = C && m.preferIconicPreview, E = C && m.preferIconicZoomPreview,
                x = function (a, l, s, c) {
                    var f = s ? "zoom-" + o : o, v = m._getPreviewTemplate(a), g = (d || "") + " " + c;
                    return m.frameClass && (g = m.frameClass + " " + g), s && (g = g.replace(" " + i.SORT_CSS, "")), v = m._parseFilePreviewIcon(v, r), "text" === a && (l = i.htmlEncode(l)), "object" !== t || n || e.each(m.defaults.fileTypeSettings, function (e, i) {
            ...
            if (n.showPreview) {
                var l, s = t ? t.name : "", d = t ? t.type : "", c = t.size || 0, u = n.slug(s),
                    p = r === !0 && !n.isUploadable, f = i.objUrl.createObjectURL(t);
                n._clearDefaultPreview(), l = n._generatePreviewTemplate("other", f, s, d, a, p, c), o.append("\n" + l), n._setThumbAttr(a, u, c), r === !0 && n.isUploadable && n._setThumbStatus(e("#" + a), "Error")
            }
        }, _previewFile: function (e, t, a, r, n) {
            if (this.showPreview) {
                var o, l = this, s = l._parseFileType(t), d = t ? t.name : "", c = l.slug(d), u = l.allowedPreviewTypes,
                    p = l.allowedPreviewMimeTypes, f = l.$preview, m = u && u.indexOf(s) >= 0, h = t.size || 0,
                    v = t.type, g = "text" === s || "html" === s || "image" === s ? a.target.result : n,
                    w = p && -1 !== p.indexOf(v);
                if ("html" === s && l.purifyHtml && window.DOMPurify && (g = window.DOMPurify.sanitize(g)), m || w) {
                    ...
                    _.length && l.autoOrientImage ? i.validateOrientation(t, function (e) {
                        if (!e) return void l._validateImage(r, c, v, h, g);
                        var a = f.find("#zoom-" + r + " img"), n = "rotate-" + e;
                        e > 4 && (n += _.width() > _.height() ? " is-portrait-gt4" : " is-landscape-gt4"), i.addCss(_, n), i.addCss(a, n), l._raise("fileimageoriented", {
                            $img: _,
                            file: t
                        }), l._validateImage(r, c, v, h, g), i.adjustOrientedImage(_)
                    }) : l._validateImage(r, c, v, h, g)
                } else l._previewDefault(t, r);
            ...
            var a, r = this, n = r.$element, o = r.$preview, l = r.reader, s = r.$previewContainer,
                d = r.$previewStatus, c = r.msgLoading, u = r.msgProgress, p = r.previewInitId, f = t.length,
                m = r.fileTypeSettings, h = r.filestack.length, v = r.allowedFileTypes, g = v ? v.length : 0,
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(t, function (e, i) {
                ...
                var T, E, x, S, F, I, k, P, z, A, $ = h + e, D = p + "-" + $, U = t[e],
                    B = U.name ? r.slug(U.name) : "", j = (U.size || 0) / 1e3, R = "", L = i.objUrl.createObjectURL(U),
                    O = 0, Z = "";
                if (g > 0) for (S = 0; g > S; S++) P = v[S], z = r.msgFileTypes[P] || P, Z += 0 === S ? z : ", " + z;
                if (B === !1) return void a(e + 1);
                if (0 === B.length) return F = r.msgInvalidFileName.replace("{name}", i.htmlEncode(U.name)), void (r.isError = y(F, U, D, e));
                if (i.isEmpty(w) || (R = new RegExp("\\.(" + w.join("|") + ")$", "i")), x = j.toFixed(2), r.maxFileSize > 0 && j > r.maxFileSize) return F = r.msgSizeTooLarge.setTokens({
                    name: B,
                    size: x,
                    maxSize: r.maxFileSize
                }), void (r.isError = y(F, U, D, e));
                if (null !== r.minFileSize && j <= i.getNum(r.minFileSize)) return F = r.msgSizeTooSmall.setTokens({
                    name: B,
                    size: x,
                    minSize: r.minFileSize
                }), void (r.isError = y(F, U, D, e));
                if (!i.isEmpty(v) && i.isArray(v)) {
                    for (S = 0; S < v.length; S += 1) I = v[S], A = m[I], O += A && "function" == typeof A && A(U.type, U.name) ? 1 : 0;
                    if (0 === O) return F = r.msgInvalidFileType.setTokens({
                        name: B,
                        types: Z
                    }), void (r.isError = y(F, U, D, e))
                }
                return 0 !== O || i.isEmpty(w) || !i.isArray(w) || i.isEmpty(R) || (k = i.compare(B, R), O += i.isEmpty(k) ? 0 : k.length, 0 !== O) ? r.showPreview ? !C && j > b ? (r.addToStack(U), s.addClass("file-thumb-loading"), r._previewDefault(U, D), r._initFileActions(), r._updateFileDetails(f), void a(e + 1)) : (o.length && void 0 !== FileReader ? (d.html(c.replace("{index}", e + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                    ...
                    if (i.lengthComputable) {
                        ...
                        F = u.setTokens({index: e + 1, files: f, percent: a, name: B}), setTimeout(function () {
                            d.html(F)
                        }, 100)
                    }
                    ...
                    a(e + 1), r._updateFileDetails(f)
                }, 100), void r._raise("fileloaded", [U, D, e, l])) : (F = r.msgInvalidFileExtension.setTokens({
                    name: B,
                    extensions: _
                }), void (r.isError = y(F, U, D, e)))
            ...
            if (t.showPreview) {
                ...
                e.removeClass("file-preview-success file-preview-error file-preview-loading"), "Success" === i && (e.find(".file-drag-handle").remove(), o.css("margin-left", 0)), o.html(l[a]), o.attr("title", l[r]), e.addClass(n), "Error" !== i || t.retryErrorUploads || e.find(".kv-file-upload").attr("disabled", !0)
            }
            ...
            t = t || n.$progress, i.isEmpty(d) || (r = l && o > l && 100 >= e ? d.setTokens({
                percent: l,
                status: n.msgUploadThreshold
            }) : d.setTokens({
                percent: o,
                status: e > 100 ? n.msgUploadEnd : o + "%"
            }), t.html(r), a && t.find('[role="progressbar"]').html(a))
        ...
        }, _setPreviewError: function (e, i, t, a) {
            var r = this;
            void 0 !== i && r.updateStack(i, t), r.removeFromPreviewOnError && !a ? e.remove() : r._setThumbStatus(e, "Error"), r._refreshUploadButton(e, a)
        }, _refreshUploadButton: function (e, i) {
            var t = this, a = e.find(".kv-file-upload"), r = t.fileActionSettings, n = r.uploadIcon, o = r.uploadTitle;
            a.length && (i && (n = r.uploadRetryIcon, o = r.uploadRetryTitle), a.attr("title", o).html(n))
            ...
            !i.isEmpty(m) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width : c.naturalHeight || c.height, u = "Small" === t ? d >= m : m >= d, u || (s = p["msgImage" + o + t].setTokens({
                name: n,
                size: m
            }), p._showUploadError(s, l), p._setPreviewError(r, e, null)))
        }, _validateImage: function (i, t, a, r, n) {
            ...
            t = t || "Untitled", m.one("load", function () {
                l = p.width(), s = u.width(), l > s && m.css("width", "100%"), o = {
                    ind: f,
                    id: i
                }, c._checkDimensions(f, "Small", m, p, t, "Width", o), c._checkDimensions(f, "Small", m, p, t, "Height", o), c.resizeImage || (c._checkDimensions(f, "Large", m, p, t, "Width", o), c._checkDimensions(f, "Large", m, p, t, "Height", o)), c._raise("fileimageloaded", [i]), d = window.piexif ? window.piexif.load(n) : null, c.loadedImages.push({
                    ind: f,
                    img: m,
                    thumb: p,
                    pid: i,
        ...
        }, _getResizedImage: function (t, a, r) {
            var n, o, l, s, d, c, u, p = this, f = e(t.img)[0], m = f.naturalWidth, h = f.naturalHeight, v = 1,
                g = p.maxImageWidth || m, w = p.maxImageHeight || h, _ = !(!m || !h), b = p.imageCanvas,
                C = p.imageCanvasContext, y = t.typ, T = t.pid, E = t.ind, x = t.thumb, S = t.exifObj;
            if (d = function (e, i, t) {
                p.isUploadable ? p._showUploadError(e, i, t) : p._showError(e, i, t), p._setPreviewError(x, E)
            }, (!p.filestack[E] || !_ || g >= m && w >= h) && (_ && p.filestack[E] && p._raise("fileimageresized", [T, E]), a.val++, a.val === r && p._raise("fileimagesresized"), !_)) return void d(p.msgImageResizeError, {
                id: T,
                index: E
            }, "fileimageresizeerror");
            y = y || p.resizeDefaultImageType, o = m > g, l = h > w, v = "width" === p.resizePreference ? o ? g / m : l ? w / h : 1 : l ? w / h : o ? g / m : 1, p._resetCanvas(), m *= v, h *= v, b.width = m, b.height = h;
            try {
                C.drawImage(f, 0, 0, m, h), s = b.toDataURL(y, p.resizeQuality), S && (u = window.piexif.dump(S), s = window.piexif.insert(u, s)), n = i.dataURI2Blob(s), p.filestack[E] = n, p._raise("fileimageresized", [T, E]), a.val++, a.val === r && p._raise("fileimagesresized", [void 0, void 0]), n instanceof Blob || d(p.msgImageResizeError, {
                    id: T,
                    index: E
                }, "fileimageresizeerror")
            } catch (F) {
                a.val++, a.val === r && p._raise("fileimagesresized", [void 0, void 0]), c = p.msgImageResizeException.replace("{errors}", F.message), d(c, {
                    id: T,
                    index: E
            ...
            return r += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", i.isEmpty(l) || (l = ' <span class="' + t.buttonLabelClass + '">' + l + "</span>"), a.setTokens({
                type: d,
                css: r,
                title: n,
                status: s,
            ...
            var n, o = this, l = o.fileActionSettings, s = l.showRemove, d = l.showDrag, c = l.showUpload,
                u = l.showZoom, p = o._getLayoutTemplate("footer"), f = r ? l.indicatorError : l.indicatorNew,
                m = o._getLayoutTemplate("indicator"), h = r ? l.indicatorErrorTitle : l.indicatorNewTitle,
                v = m.setTokens({indicator: f, indicatorTitle: h});
            return t = o._getSize(t), n = o.isUploadable ? p.setTokens({
            ...
            if (!(e || i || t || a)) return "";
            var s, d = this, c = n === !1 ? "" : ' data-url="' + n + '"', u = o === !1 ? "" : ' data-key="' + o + '"',
                p = "", f = "", m = "", h = "", v = d._getLayoutTemplate("actions"), g = d.fileActionSettings,
                w = d.otherActionButtons.setTokens({dataKey: u}), _ = r ? g.removeClass + " disabled" : g.removeClass;
            return i && (p = d._getLayoutTemplate("actionDelete").setTokens({
                ...
                dragIcon: g.dragIcon
            })), v.setTokens({"delete": p, upload: f, zoom: m, drag: h, other: w})
        }, _browse: function (e) {
            var i = this;
            ...
            var n, o, l, s, d = [], c = arguments.length > 1, u = a.isUploadable,
                p = c ? t.originalEvent.dataTransfer.files : r.get(0).files, f = a.filestack.length,
                m = i.isEmpty(r.attr("multiple")), h = m && f > 0, v = 0, g = a._getFileIds(),
                w = function (i, t, r, n) {
                    var o = e.extend(!0, {}, a._getOutData({}, {}, p), {id: r, index: n}),
                        l = {id: r, index: n, file: t, files: p};
            ...
            }) : d = p), i.isEmpty(d) || 0 === d.length) return u || a.clear(), a._showFolderError(v), void a._raise("fileselectnone");
            ...
            } else !u || h ? (a._resetPreviewThumbs(!1), h && a.clearStack()) : !u || 0 !== f || a.previewCache.count() && !a.overwriteInitial || a._resetPreviewThumbs(!0);
            ...
            var t, a, r, n = this, o = n.getFileStack().length, l = !e.isEmptyObject(n._getExtraData());
            if (n.isUploadable && !n.isDisabled && n._isFileSelectionValid(o)) {
                if (n._resetUpload(), 0 === o && !l) return void n._showUploadError(n.msgUploadEmpty);
                if (n.$progress.removeClass("hide"), n.uploadCount = 0, n.uploadStatus = {}, n.uploadLog = [], n.lock(), n._setProgress(2), 0 === o && l) return void n._uploadExtraOnly();
                ...
                for (n.$preview.find(".file-preview-initial").removeClass(i.SORT_CSS), n._initSortable(), n.cacheInitialPreview = n.getPreview(), t = 0; r > t; t++) n.filestack[t] && n._uploadSingle(t, !0)
            }
        }, destroy: function () {
            var i = this, t = i.$form, a = i.$container, r = i.$element, n = i.namespace;
            return e(document).off(n), e(window).off(n), t && t.length && t.off(n), i.isUploadable && i._clearFileInput(), i._cleanup(), i._initPreviewCache(), r.insertBefore(a).off(n).removeData(), a.off().remove(), r
        }, refresh: function (i) {
            ...
            var t = this, a = t._getFrame(e), r = t.$modal;
            a && (i.initModal(r), r.html(t._getModalContent()), t._setZoomContent(a), r.modal("show"), t._initZoomButtons())
        }, getExif: function (e) {
        ...
        if (i.hasFileAPISupport() || i.isIE(9)) {
            ...
            switch (r.shift(), this.each(function () {
                ...
                s || (c && (p = e.fn.fileinputThemes[c] || {}), "en" === f || i.isEmpty(e.fn.fileinputLocales[f]) || (u = e.fn.fileinputLocales[f] || {}), o = e.extend(!0, {}, e.fn.fileinput.defaults, p, e.fn.fileinputLocales.en, u, d, l.data()), s = new t(this, o), l.data("fileinput", s)), "string" == typeof a && n.push(s[a].apply(s, r))
            }), n.length) {
                case 0:
                    return this;
                case 1:
